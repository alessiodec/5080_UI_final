...
def main_menu():
    ...
    # Show "Run Heatsink Evolution" only if an analysis has been run.
...
def load_data_page():
    ...
    # Instead of waiting for the user to click "Go Back", you can offer a "Return to Main Menu" button.
...
def run_analysis_page():
    ...
    if st.button("Run Analysis"):
        try:
            ...
            st.session_state["analysis_run"] = True  # Flag after analysis runs.
        except Exception as e:
